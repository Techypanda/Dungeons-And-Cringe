...
public class ShopController {
    ...
    /**
     * Alternate constructor for shop controller
     * @param inShop the shop model injected
     * @param inView the shop controller's view injected
     * @param thePlayer the player model injected
     * @param invController the inventory controller injected
     * @param loader the data loader injected
     */
    ...
    /**
     * Begins the shop
     * @throws ShopException if a dataload exception occured.
     */
    ...
    /**
     * Handles the enchantment of items
     * @throws ShopException if view has a error
     */
    ...
    /**
     * Handles purchase of items from shop
     * @throws ShopException if view has a error
     */
